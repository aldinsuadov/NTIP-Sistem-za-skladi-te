...
import { WarehouseUsersSection } from "./warehouse-users-section";
...
const shortcuts = [
  {
    href: "/admin",
    title: "Odobravanja korisnika",
    description: "Pregled i odobravanje novih registracija.",
  },
  {
    href: "/artikli",
    title: "Artikli",
    description: "Brz pristup inventaru i unosu artikala.",
  },
  {
    href: "/statistika",
    title: "Statistika",
    description: "Praćenje ključnih podataka i trendova.",
  },
];
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-muted-foreground">Brze prečice za najčešće administrativne zadatke.</p>
          </div>
        </div>
      </div>
